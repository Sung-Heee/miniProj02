...
import com.example.miniproj02.member.AuthFailureHandler;
import com.example.miniproj02.member.AuthSuccessHandler;
import com.example.miniproj02.member.MemberService;
    ...
    protected void configure(HttpSecurity http) throws Exception {
		...
		*/
        ...
        http//.csrf().disable()	// csrf 토큰을 비활성화
                ...
                .antMatchers("/", "/login/loginForm", "/login/signUp", "/resources/**").permitAll() // 해당 경로들은 접근을 허용
